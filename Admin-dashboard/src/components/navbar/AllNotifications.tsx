...
const AllNotifications:FC<Props> = ({isOpen, onOpenChange}) => {
  return (
    <>
      <Drawer
        isOpen={isOpen}
            ...
            <>
              ...
              <DrawerBody>
                ...
                <div>
                  <a
                    href="#"
                    className="flex py-3 px-4 rounded-xl border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600"
                  >
                  ...
                  <a
                    href="#"
                    className="flex py-3 px-4 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-600"
                  >
                    <div className="flex-shrink-0">
                      <img
                        className="w-11 h-11 rounded-full"
